...
\note{Copy over some of the high level ideas from the appendix, and maybe remove
...
\section{Linear Cursors}\label{subsec:linear}

\note{Brief lead-in about how this is a different language and why it's in this
  section.}
\note{Copy the types from the ECOOP paper and/or the Linear Haskell paper.}
\note{Reference this in the Gibbon chapter when we get to the cursor-passing
  language.}
\note{Add a forward reference to this at the beginning of the chapter so it
