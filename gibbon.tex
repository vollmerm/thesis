...
\mav{Put full data and plot from course compiler benchmark here}
...
\item \textbf{countNodes}:
  This benchmark taken from LoCal's benchmark suite.
  %
...
We do not include some other classic benchmarks such as Mandelbrot,
dense matrix multiplication etc. since they do not require allocating or traversing data
in serialized heaps.
%
With our compiler, these benchmarks would perform similarly to their
implementations written using C/C++, as shown by the in-place
merge sort benchmark.

\Figref{fig:benchmark-results} shows the full results of comparing performance
of programs compiled with Parallel Gibbon to the other implementations.
