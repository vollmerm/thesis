...
In my thesis I am proposing a way to ameliorate this tension: reify {\em data
layout} as an explicit part of the program. I will introduce a language,
...
\note{Summarize the whole thesis here.}
\note{Briefly introduce LoCal and Gibbon and tease some evaluation resluts.}
